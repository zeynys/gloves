AddEventHandler("OnPluginStart", function(event)
    ...
    db:Query(
        "CREATE TABLE `gloves` (`steamid` VARCHAR(64) NOT NULL , `t` VARCHAR(64) NOT NULL , `ct` VARCHAR(64) NOT NULL , `gloves_data` JSON NOT NULL DEFAULT '{}' , UNIQUE (`steamid`)) ENGINE = InnoDB;"
    )
